...
static pj_status_t app_init()
{
	...
	app_config.cfg.cb.on_pjmedia_file_receive_progress = &on_pjmedia_file_receive_progress;
	app_config.cfg.cb.on_pjmedia_file_receive_result = &on_pjmedia_file_receive_result;
	app_config.cfg.cb.on_pjmedia_file_send_progress = &on_pjmedia_file_send_progress;
	app_config.cfg.cb.on_pjmedia_file_send_result = &on_pjmedia_file_send_result;
	app_config.cfg.cb.on_pjmedia_msg_receive_result = &on_pjmedia_msg_receive_result;
	app_config.cfg.cb.on_pjmedia_msg_send_result = &on_pjmedia_msg_send_result;
#ifdef TRANSPORT_ADAPTER_SAMPLE
	...
	call_opt.aud_cnt = app_config.aud_cnt;
	call_opt.vid_cnt = app_config.vid.vid_cnt;
	m_StegFile.initStegFile(app_config.pool);
	pj_pool_release(tmp_pool);
	return PJ_SUCCESS;
